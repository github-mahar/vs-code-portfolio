export const PORTFOLIO_DATA = {
  name: "Mahar Ghulam Muhammad (GM)",
  title: "React Developer | React.js, TypeScript, REST API Integration, E-Commerce Front-End",
  ...
  certifications: [
    {
      ...
      issuer: "Anthropic",
      description: "AI architecture, prompt engineering, and LLM application integration."
    },
    {
      title: "Full Stack Development",
      issuer: "Government of Punjab (eHunhar Program)",
      description: "Comprehensive Web Application Architecture, Modern JavaScript/TypeScript, Full Stack Development."
    },
    {
      title: "Virtual Assistant",
      issuer: "Daraz",
      description: "E-Commerce Operations, Store Management & Digital Marketing."
    }
  ],
